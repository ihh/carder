...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  var construct = function construct() {
	    ...
	    if ((0, _utilities.isTouchDevice)()) {
	      ...
	      targetElement.addEventListener('touchend', function () {
	        if (config.allowMovement(event, true)) if (isDraging && !isPanning) {
	          eventEmitter.trigger('dragend', {
	            target: targetElement
	          });
	        }
	      ...
	      targetElement.addEventListener('mousedown', function () {
	        if (config.allowMovement(event, false)) eventEmitter.trigger('panstart');
	      });
	    ...
	    mc.on('panmove', function (event) {
	      if (config.allowMovement(event, (0, _utilities.isTouchDevice)())) {
	...
	Card.makeConfig = function (config) {
	  ...
	  var defaultConfig = {
	    ...
	    allowMovement: function allowMovement() {
	      return true;
	    },
